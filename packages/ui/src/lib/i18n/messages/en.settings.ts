...
export const settingsDict = {
  ...
  'settings.openchamber.codexCli.description': 'Check whether Codex is available on this host and manage ChatGPT sign-in. OpenChamber does not store your token.',
  'settings.openchamber.codexCli.state.authUnavailable': 'ChatGPT sign-in is not available from this runtime.',
  'settings.openchamber.codexCli.section.host': 'Host',
  'settings.openchamber.codexCli.section.account': 'Account',
  'settings.openchamber.codexCli.field.availability': 'Availability',
  'settings.openchamber.codexCli.field.version': 'Version',
  'settings.openchamber.codexCli.field.account': 'Account',
  'settings.openchamber.codexCli.field.login': 'Sign-in',
  'settings.openchamber.codexCli.field.logout': 'Sign-out',
  'settings.openchamber.codexCli.field.verificationUrl': 'Verification URL',
  'settings.openchamber.codexCli.field.deviceCode': 'Device code',
  'settings.openchamber.codexCli.state.loading': 'Checking…',
  'settings.openchamber.codexCli.state.available': 'Available',
  'settings.openchamber.codexCli.state.unavailable': 'Unavailable',
  'settings.openchamber.codexCli.state.unknown': 'Unknown',
  'settings.openchamber.codexCli.state.clientUnavailable': 'Codex client is not connected',
  'settings.openchamber.codexCli.state.notSignedIn': 'Not signed in',
  'settings.openchamber.codexCli.state.loginInProgress': 'Signing in…',
  'settings.openchamber.codexCli.state.deviceCodeInstructions': 'Open the verification URL and enter the device code to finish signing in with ChatGPT.',
  'settings.openchamber.codexCli.actions.refresh': 'Refresh',
  'settings.openchamber.codexCli.actions.refreshing': 'Refreshing…',
  'settings.openchamber.codexCli.actions.login': 'Sign in with ChatGPT',
  'settings.openchamber.codexCli.actions.cancelLogin': 'Cancel sign-in',
  'settings.openchamber.codexCli.actions.cancellingLogin': 'Cancelling sign-in…',
  'settings.openchamber.codexCli.actions.logout': 'Sign out',
  'settings.openchamber.codexCli.actions.loggingOut': 'Signing out…',
  'settings.openchamber.codexCli.actions.openVerificationUrl': 'Open verification URL',
  'settings.openchamber.codexCli.toast.refreshFailed': 'Could not refresh Codex status.',
  'settings.openchamber.codexCli.toast.loginFailed': 'ChatGPT sign-in failed.',
  'settings.openchamber.codexCli.toast.cancelLoginFailed': 'Could not cancel ChatGPT sign-in.',
  'settings.openchamber.codexCli.toast.logoutFailed': 'Could not sign out of ChatGPT.',
  'settings.projects.page.agentBackend.title': 'Agent backend',
  'settings.projects.page.agentBackend.description': 'Choose which agent backend new sessions in this project use. OpenCode is the default.',
  ...
  'settings.projects.page.agentBackend.option.codexUnavailable': 'Codex (unavailable)',
  'settings.projects.page.agentBackend.state.checkingCodex': 'Checking Codex availability…',
  'settings.projects.page.agentBackend.state.codexUnavailable': 'Codex is unavailable on this host.',
