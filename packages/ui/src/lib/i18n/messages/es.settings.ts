...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  'settings.openchamber.codexCli.title': 'CLI de Codex',
  'settings.openchamber.codexCli.description': 'Comprueba si Codex está disponible en este host y gestiona el inicio de sesión de ChatGPT. OpenChamber no almacena tu token.',
  'settings.openchamber.codexCli.state.authUnavailable': 'El inicio de sesión de ChatGPT no está disponible en este entorno.',
  'settings.openchamber.codexCli.section.host': 'Host',
  'settings.openchamber.codexCli.section.account': 'Cuenta',
  'settings.openchamber.codexCli.field.availability': 'Disponibilidad',
  'settings.openchamber.codexCli.field.version': 'Versión',
  'settings.openchamber.codexCli.field.account': 'Cuenta',
  'settings.openchamber.codexCli.field.login': 'Inicio de sesión',
  'settings.openchamber.codexCli.field.logout': 'Cerrar sesión',
  'settings.openchamber.codexCli.field.verificationUrl': 'URL de verificación',
  'settings.openchamber.codexCli.field.deviceCode': 'Código de dispositivo',
  'settings.openchamber.codexCli.state.loading': 'Comprobando…',
  'settings.openchamber.codexCli.state.available': 'Disponible',
  'settings.openchamber.codexCli.state.unavailable': 'No disponible',
  'settings.openchamber.codexCli.state.unknown': 'Desconocido',
  'settings.openchamber.codexCli.state.clientUnavailable': 'El cliente de Codex no está conectado',
  'settings.openchamber.codexCli.state.notSignedIn': 'No has iniciado sesión',
  'settings.openchamber.codexCli.state.loginInProgress': 'Iniciando sesión…',
  'settings.openchamber.codexCli.state.deviceCodeInstructions': 'Abre la URL de verificación e introduce el código del dispositivo para completar el inicio de sesión en ChatGPT.',
  'settings.openchamber.codexCli.actions.refresh': 'Actualizar',
  'settings.openchamber.codexCli.actions.refreshing': 'Actualizando…',
  'settings.openchamber.codexCli.actions.login': 'Iniciar sesión con ChatGPT',
  'settings.openchamber.codexCli.actions.cancelLogin': 'Cancelar inicio de sesión',
  'settings.openchamber.codexCli.actions.cancellingLogin': 'Cancelando inicio de sesión…',
  'settings.openchamber.codexCli.actions.logout': 'Cerrar sesión',
  'settings.openchamber.codexCli.actions.loggingOut': 'Cerrando sesión…',
  'settings.openchamber.codexCli.actions.openVerificationUrl': 'Abrir URL de verificación',
  'settings.openchamber.codexCli.toast.refreshFailed': 'No se pudo actualizar el estado de Codex.',
  'settings.openchamber.codexCli.toast.loginFailed': 'Error al iniciar sesión en ChatGPT.',
  'settings.openchamber.codexCli.toast.cancelLoginFailed': 'No se pudo cancelar el inicio de sesión en ChatGPT.',
  'settings.openchamber.codexCli.toast.logoutFailed': 'No se pudo cerrar la sesión de ChatGPT.',
  'settings.projects.page.agentBackend.title': 'Backend del agente',
  'settings.projects.page.agentBackend.description': 'Elige el backend de agente que usarán las nuevas sesiones de este proyecto. OpenCode es el predeterminado.',
  'settings.projects.page.agentBackend.field.backend': 'Backend',
  'settings.projects.page.agentBackend.option.opencode': 'OpenCode',
  'settings.projects.page.agentBackend.option.codex': 'Codex',
  'settings.projects.page.agentBackend.option.codexUnavailable': 'Codex (no disponible)',
  'settings.projects.page.agentBackend.state.checkingCodex': 'Comprobando la disponibilidad de Codex…',
  'settings.projects.page.agentBackend.state.codexUnavailable': 'Codex no está disponible en este host.',
