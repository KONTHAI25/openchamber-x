...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.codexCli.description': '이 호스트에서 Codex를 사용할 수 있는지 확인하고 ChatGPT 로그인을 관리합니다. OpenChamber는 토큰을 저장하지 않습니다.',
  'settings.openchamber.codexCli.state.authUnavailable': '이 런타임에서는 ChatGPT 로그인을 사용할 수 없습니다.',
  'settings.openchamber.codexCli.section.host': '호스트',
  'settings.openchamber.codexCli.section.account': '계정',
  'settings.openchamber.codexCli.field.availability': '사용 가능 여부',
  'settings.openchamber.codexCli.field.version': '버전',
  'settings.openchamber.codexCli.field.account': '계정',
  'settings.openchamber.codexCli.field.login': '로그인',
  'settings.openchamber.codexCli.field.logout': '로그아웃',
  'settings.openchamber.codexCli.field.verificationUrl': '인증 URL',
  'settings.openchamber.codexCli.field.deviceCode': '디바이스 코드',
  'settings.openchamber.codexCli.state.loading': '확인 중…',
  'settings.openchamber.codexCli.state.available': '사용 가능',
  'settings.openchamber.codexCli.state.unavailable': '사용 불가',
  'settings.openchamber.codexCli.state.unknown': '알 수 없음',
  'settings.openchamber.codexCli.state.clientUnavailable': 'Codex 클라이언트가 연결되지 않음',
  'settings.openchamber.codexCli.state.notSignedIn': '로그인되지 않음',
  'settings.openchamber.codexCli.state.loginInProgress': '로그인 중…',
  'settings.openchamber.codexCli.state.deviceCodeInstructions': '인증 URL을 열고 디바이스 코드를 입력하여 ChatGPT 로그인을 완료하세요.',
  'settings.openchamber.codexCli.actions.refresh': '새로 고침',
  'settings.openchamber.codexCli.actions.refreshing': '새로 고치는 중…',
  'settings.openchamber.codexCli.actions.login': 'ChatGPT로 로그인',
  'settings.openchamber.codexCli.actions.cancelLogin': '로그인 취소',
  'settings.openchamber.codexCli.actions.cancellingLogin': '로그인 취소 중…',
  'settings.openchamber.codexCli.actions.logout': '로그아웃',
  'settings.openchamber.codexCli.actions.loggingOut': '로그아웃 중…',
  'settings.openchamber.codexCli.actions.openVerificationUrl': '인증 URL 열기',
  'settings.openchamber.codexCli.toast.refreshFailed': 'Codex 상태를 새로 고치지 못했습니다.',
  'settings.openchamber.codexCli.toast.loginFailed': 'ChatGPT 로그인에 실패했습니다.',
  'settings.openchamber.codexCli.toast.cancelLoginFailed': 'ChatGPT 로그인을 취소하지 못했습니다.',
  'settings.openchamber.codexCli.toast.logoutFailed': 'ChatGPT에서 로그아웃하지 못했습니다.',
  'settings.projects.page.agentBackend.title': '에이전트 백엔드',
  'settings.projects.page.agentBackend.description': '이 프로젝트의 새 세션에서 사용할 에이전트 백엔드를 선택합니다. 기본값은 OpenCode입니다.',
  'settings.projects.page.agentBackend.field.backend': '백엔드',
  'settings.projects.page.agentBackend.option.opencode': 'OpenCode',
  'settings.projects.page.agentBackend.option.codex': 'Codex',
  'settings.projects.page.agentBackend.option.codexUnavailable': 'Codex(사용할 수 없음)',
  'settings.projects.page.agentBackend.state.checkingCodex': 'Codex 사용 가능 여부 확인 중…',
  'settings.projects.page.agentBackend.state.codexUnavailable': '이 호스트에서는 Codex를 사용할 수 없습니다.',
