...
export const settingsDict = {
  ...
  'settings.openchamber.codexCli.description': 'Sprawdź, czy Codex jest dostępny na tym hoście, i zarządzaj logowaniem do ChatGPT. OpenChamber nie przechowuje tokenu.',
  'settings.openchamber.codexCli.state.authUnavailable': 'Logowanie do ChatGPT nie jest dostępne w tym środowisku.',
  'settings.openchamber.codexCli.section.host': 'Host',
  'settings.openchamber.codexCli.section.account': 'Konto',
  'settings.openchamber.codexCli.field.availability': 'Dostępność',
  'settings.openchamber.codexCli.field.version': 'Wersja',
  'settings.openchamber.codexCli.field.account': 'Konto',
  'settings.openchamber.codexCli.field.login': 'Logowanie',
  'settings.openchamber.codexCli.field.logout': 'Wylogowanie',
  'settings.openchamber.codexCli.field.verificationUrl': 'URL weryfikacyjny',
  'settings.openchamber.codexCli.field.deviceCode': 'Kod urządzenia',
  'settings.openchamber.codexCli.state.loading': 'Sprawdzanie…',
  'settings.openchamber.codexCli.state.available': 'Dostępny',
  'settings.openchamber.codexCli.state.unavailable': 'Niedostępny',
  'settings.openchamber.codexCli.state.unknown': 'Nieznany',
  'settings.openchamber.codexCli.state.clientUnavailable': 'Klient Codex nie jest połączony',
  'settings.openchamber.codexCli.state.notSignedIn': 'Nie zalogowano',
  'settings.openchamber.codexCli.state.loginInProgress': 'Logowanie…',
  'settings.openchamber.codexCli.state.deviceCodeInstructions': 'Otwórz URL weryfikacyjny i wpisz kod urządzenia, aby dokończyć logowanie do ChatGPT.',
  'settings.openchamber.codexCli.actions.refresh': 'Odśwież',
  'settings.openchamber.codexCli.actions.refreshing': 'Odświeżanie…',
  'settings.openchamber.codexCli.actions.login': 'Zaloguj przez ChatGPT',
  'settings.openchamber.codexCli.actions.cancelLogin': 'Anuluj logowanie',
  'settings.openchamber.codexCli.actions.cancellingLogin': 'Anulowanie logowania…',
  'settings.openchamber.codexCli.actions.logout': 'Wyloguj',
  'settings.openchamber.codexCli.actions.loggingOut': 'Wylogowywanie…',
  'settings.openchamber.codexCli.actions.openVerificationUrl': 'Otwórz URL weryfikacyjny',
  'settings.openchamber.codexCli.toast.refreshFailed': 'Nie udało się odświeżyć stanu Codex.',
  'settings.openchamber.codexCli.toast.loginFailed': 'Logowanie do ChatGPT nie powiodło się.',
  'settings.openchamber.codexCli.toast.cancelLoginFailed': 'Nie udało się anulować logowania do ChatGPT.',
  'settings.openchamber.codexCli.toast.logoutFailed': 'Nie udało się wylogować z ChatGPT.',
  'settings.projects.page.agentBackend.title': 'Backend agenta',
  'settings.projects.page.agentBackend.description': 'Wybierz backend agenta używany przez nowe sesje w tym projekcie. Domyślny backend to OpenCode.',
  ...
  'settings.projects.page.agentBackend.option.codexUnavailable': 'Codex (niedostępny)',
  'settings.projects.page.agentBackend.state.checkingCodex': 'Sprawdzanie dostępności Codex…',
  'settings.projects.page.agentBackend.state.codexUnavailable': 'Codex jest niedostępny na tym hoście.',
