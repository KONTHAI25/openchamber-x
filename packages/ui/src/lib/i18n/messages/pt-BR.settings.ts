...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  'settings.openchamber.codexCli.title': 'CLI do Codex',
  'settings.openchamber.codexCli.description': 'Verifique se o Codex está disponível neste host e gerencie o login do ChatGPT. O OpenChamber não armazena seu token.',
  'settings.openchamber.codexCli.state.authUnavailable': 'O login do ChatGPT não está disponível neste ambiente.',
  'settings.openchamber.codexCli.section.host': 'Host',
  'settings.openchamber.codexCli.section.account': 'Conta',
  'settings.openchamber.codexCli.field.availability': 'Disponibilidade',
  'settings.openchamber.codexCli.field.version': 'Versão',
  'settings.openchamber.codexCli.field.account': 'Conta',
  'settings.openchamber.codexCli.field.login': 'Login',
  'settings.openchamber.codexCli.field.logout': 'Logout',
  'settings.openchamber.codexCli.field.verificationUrl': 'URL de verificação',
  'settings.openchamber.codexCli.field.deviceCode': 'Código do dispositivo',
  'settings.openchamber.codexCli.state.loading': 'Verificando…',
  'settings.openchamber.codexCli.state.available': 'Disponível',
  'settings.openchamber.codexCli.state.unavailable': 'Indisponível',
  'settings.openchamber.codexCli.state.unknown': 'Desconhecido',
  'settings.openchamber.codexCli.state.clientUnavailable': 'O cliente do Codex não está conectado',
  'settings.openchamber.codexCli.state.notSignedIn': 'Não conectado',
  'settings.openchamber.codexCli.state.loginInProgress': 'Fazendo login…',
  'settings.openchamber.codexCli.state.deviceCodeInstructions': 'Abra a URL de verificação e digite o código do dispositivo para concluir o login no ChatGPT.',
  'settings.openchamber.codexCli.actions.refresh': 'Atualizar',
  'settings.openchamber.codexCli.actions.refreshing': 'Atualizando…',
  'settings.openchamber.codexCli.actions.login': 'Entrar com ChatGPT',
  'settings.openchamber.codexCli.actions.cancelLogin': 'Cancelar login',
  'settings.openchamber.codexCli.actions.cancellingLogin': 'Cancelando login…',
  'settings.openchamber.codexCli.actions.logout': 'Sair',
  'settings.openchamber.codexCli.actions.loggingOut': 'Saindo…',
  'settings.openchamber.codexCli.actions.openVerificationUrl': 'Abrir URL de verificação',
  'settings.openchamber.codexCli.toast.refreshFailed': 'Não foi possível atualizar o status do Codex.',
  'settings.openchamber.codexCli.toast.loginFailed': 'Falha no login do ChatGPT.',
  'settings.openchamber.codexCli.toast.cancelLoginFailed': 'Não foi possível cancelar o login do ChatGPT.',
  'settings.openchamber.codexCli.toast.logoutFailed': 'Não foi possível sair do ChatGPT.',
  'settings.projects.page.agentBackend.title': 'Backend do agente',
  'settings.projects.page.agentBackend.description': 'Escolha o backend de agente usado pelas novas sessões deste projeto. OpenCode é o padrão.',
  ...
  'settings.projects.page.agentBackend.option.codexUnavailable': 'Codex (indisponível)',
  'settings.projects.page.agentBackend.state.checkingCodex': 'Verificando a disponibilidade do Codex…',
  'settings.projects.page.agentBackend.state.codexUnavailable': 'O Codex não está disponível neste host.',
