...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  'settings.openchamber.codexCli.description': 'Перевірте доступність Codex на цьому хості та керуйте входом у ChatGPT. OpenChamber не зберігає ваш токен.',
  'settings.openchamber.codexCli.state.authUnavailable': 'Вхід у ChatGPT недоступний у цьому середовищі.',
  'settings.openchamber.codexCli.section.host': 'Хост',
  'settings.openchamber.codexCli.section.account': 'Обліковий запис',
  'settings.openchamber.codexCli.field.availability': 'Доступність',
  'settings.openchamber.codexCli.field.version': 'Версія',
  'settings.openchamber.codexCli.field.account': 'Обліковий запис',
  'settings.openchamber.codexCli.field.login': 'Вхід',
  'settings.openchamber.codexCli.field.logout': 'Вихід',
  'settings.openchamber.codexCli.field.verificationUrl': 'URL підтвердження',
  'settings.openchamber.codexCli.field.deviceCode': 'Код пристрою',
  'settings.openchamber.codexCli.state.loading': 'Перевірка…',
  'settings.openchamber.codexCli.state.available': 'Доступний',
  'settings.openchamber.codexCli.state.unavailable': 'Недоступний',
  'settings.openchamber.codexCli.state.unknown': 'Невідомо',
  'settings.openchamber.codexCli.state.clientUnavailable': 'Клієнт Codex не підключено',
  'settings.openchamber.codexCli.state.notSignedIn': 'Не виконано вхід',
  'settings.openchamber.codexCli.state.loginInProgress': 'Виконується вхід…',
  'settings.openchamber.codexCli.state.deviceCodeInstructions': 'Відкрийте URL підтвердження та введіть код пристрою, щоб завершити вхід у ChatGPT.',
  'settings.openchamber.codexCli.actions.refresh': 'Оновити',
  'settings.openchamber.codexCli.actions.refreshing': 'Оновлення…',
  'settings.openchamber.codexCli.actions.login': 'Увійти через ChatGPT',
  'settings.openchamber.codexCli.actions.cancelLogin': 'Скасувати вхід',
  'settings.openchamber.codexCli.actions.cancellingLogin': 'Скасування входу…',
  'settings.openchamber.codexCli.actions.logout': 'Вийти',
  'settings.openchamber.codexCli.actions.loggingOut': 'Виконується вихід…',
  'settings.openchamber.codexCli.actions.openVerificationUrl': 'Відкрити URL підтвердження',
  'settings.openchamber.codexCli.toast.refreshFailed': 'Не вдалося оновити стан Codex.',
  'settings.openchamber.codexCli.toast.loginFailed': 'Не вдалося ввійти в ChatGPT.',
  'settings.openchamber.codexCli.toast.cancelLoginFailed': 'Не вдалося скасувати вхід у ChatGPT.',
  'settings.openchamber.codexCli.toast.logoutFailed': 'Не вдалося вийти з ChatGPT.',
  'settings.projects.page.agentBackend.title': 'Бекенд агента',
  'settings.projects.page.agentBackend.description': 'Виберіть бекенд агента для нових сеансів цього проєкту. Типовий варіант — OpenCode.',
  'settings.projects.page.agentBackend.field.backend': 'Бекенд',
  'settings.projects.page.agentBackend.option.opencode': 'OpenCode',
  'settings.projects.page.agentBackend.option.codex': 'Codex',
  'settings.projects.page.agentBackend.option.codexUnavailable': 'Codex (недоступний)',
  'settings.projects.page.agentBackend.state.checkingCodex': 'Перевірка доступності Codex…',
  'settings.projects.page.agentBackend.state.codexUnavailable': 'Codex недоступний на цьому хості.',
