...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.codexCli.description': '检查此主机上是否可用 Codex，并管理 ChatGPT 登录。OpenChamber 不会存储你的令牌。',
  'settings.openchamber.codexCli.state.authUnavailable': '此运行环境不支持 ChatGPT 登录。',
  'settings.openchamber.codexCli.section.host': '主机',
  'settings.openchamber.codexCli.section.account': '账户',
  'settings.openchamber.codexCli.field.availability': '可用性',
  'settings.openchamber.codexCli.field.version': '版本',
  'settings.openchamber.codexCli.field.account': '账户',
  'settings.openchamber.codexCli.field.login': '登录',
  'settings.openchamber.codexCli.field.logout': '登出',
  'settings.openchamber.codexCli.field.verificationUrl': '验证 URL',
  'settings.openchamber.codexCli.field.deviceCode': '设备代码',
  'settings.openchamber.codexCli.state.loading': '检查中…',
  ...
  'settings.openchamber.codexCli.state.clientUnavailable': 'Codex 客户端未连接',
  'settings.openchamber.codexCli.state.notSignedIn': '未登录',
  'settings.openchamber.codexCli.state.loginInProgress': '正在登录…',
  'settings.openchamber.codexCli.state.deviceCodeInstructions': '打开验证 URL 并输入设备代码，以完成 ChatGPT 登录。',
  'settings.openchamber.codexCli.actions.refresh': '刷新',
  'settings.openchamber.codexCli.actions.refreshing': '刷新中…',
  'settings.openchamber.codexCli.actions.login': '使用 ChatGPT 登录',
  'settings.openchamber.codexCli.actions.cancelLogin': '取消登录',
  'settings.openchamber.codexCli.actions.cancellingLogin': '正在取消登录…',
  'settings.openchamber.codexCli.actions.logout': '登出',
  'settings.openchamber.codexCli.actions.loggingOut': '正在登出…',
  'settings.openchamber.codexCli.actions.openVerificationUrl': '打开验证 URL',
  'settings.openchamber.codexCli.toast.refreshFailed': '无法刷新 Codex 状态。',
  'settings.openchamber.codexCli.toast.loginFailed': 'ChatGPT 登录失败。',
  'settings.openchamber.codexCli.toast.cancelLoginFailed': '无法取消 ChatGPT 登录。',
  'settings.openchamber.codexCli.toast.logoutFailed': '无法退出 ChatGPT。',
  'settings.projects.page.agentBackend.title': '代理后端',
  'settings.projects.page.agentBackend.description': '选择此项目新会话使用的代理后端。默认使用 OpenCode。',
  'settings.projects.page.agentBackend.field.backend': '后端',
  ...
  'settings.projects.page.agentBackend.state.checkingCodex': '正在检查 Codex 可用性…',
  'settings.projects.page.agentBackend.state.codexUnavailable': '此主机上无法使用 Codex。',
