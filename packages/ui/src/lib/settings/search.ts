...
const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.openchamber.codexCli.title',
    descriptionKey: 'settings.openchamber.codexCli.description',
    keywords: ['codex', 'cli', 'chatgpt', 'openai', 'login', 'account'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'general.codex-cli-host',
    page: 'general',
    titleKey: 'settings.openchamber.codexCli.section.host',
    keywords: ['codex', 'host', 'availability', 'version'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'general.codex-cli-availability',
    page: 'general',
    titleKey: 'settings.openchamber.codexCli.field.availability',
    keywords: ['codex', 'available', 'installed', 'host'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'general.codex-cli-version',
    page: 'general',
    titleKey: 'settings.openchamber.codexCli.field.version',
    keywords: ['codex', 'version', 'host'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'general.codex-cli-account',
    page: 'general',
    titleKey: 'settings.openchamber.codexCli.field.account',
    keywords: ['codex', 'account', 'chatgpt', 'openai'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'general.codex-cli-refresh',
    page: 'general',
    titleKey: 'settings.openchamber.codexCli.actions.refresh',
    keywords: ['codex', 'refresh', 'reload', 'status'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'general.codex-cli-login',
    page: 'general',
    titleKey: 'settings.openchamber.codexCli.actions.login',
    keywords: ['codex', 'chatgpt', 'login', 'sign in', 'device code', 'oauth'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'general.codex-cli-logout',
    page: 'general',
    titleKey: 'settings.openchamber.codexCli.actions.logout',
    keywords: ['codex', 'chatgpt', 'logout', 'sign out', 'account'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
  ...
  {
    id: 'projects.agent-backend',
    page: 'projects',
    titleKey: 'settings.projects.page.agentBackend.title',
    descriptionKey: 'settings.projects.page.agentBackend.description',
    keywords: ['project', 'agent', 'backend', 'opencode', 'codex', 'chatgpt'],
  },
  {
